...
> Updated at the S4.15 close (2026-07-12) — the documentation pack.
...
inherits the register's checkability.
...
D-numbers (next free: **D-255**) → artifacts delivered as local
