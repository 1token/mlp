...
> Updated at the S4.16 close (2026-07-14) — the scenario suite.
...
D-139 line (4 MiB) selects which accept path a scenario exercises.
...
D-numbers (next free: **D-256**) → artifacts delivered as local
